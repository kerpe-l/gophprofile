...
// etagLen — сколько шестнадцатеричных знаков хеша уходит в ETag. Валидатор
// кеша не обязан быть криптостойким: 64 бита исключают случайное совпадение
// с ETag хранилища, а короткое значение дешевле гонять в каждом заголовке.
const etagLen = 16
