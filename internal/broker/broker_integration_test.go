...
// testDelays — укороченная лестница: на стандартной тест ждал бы больше
// пятнадцати минут.
...
// BrokerSuite поднимает брокер один раз на весь набор. Изоляция — уникальными
// идентификаторами сообщений и тем, что каждый тест подтверждает всё, что взял.
...
// Обе ветки классификации проверяются разом:
