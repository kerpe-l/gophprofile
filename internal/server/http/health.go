...
// и 503 с degraded, если отвалилась хотя бы одна.
//
// Проверки идут параллельно: последовательные складывали бы задержки, и три
// подвисшие зависимости давали бы шесть секунд на ответ, который нужен
// оркестратору быстро. Горутин ровно столько, сколько зависимостей.
