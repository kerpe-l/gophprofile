...
// writeContent переливает изображение из хранилища в ответ, не буферизуя его,
// и закрывает тело в любом исходе.
...
// matchETag сверяет If-None-Match с валидатором ответа: принимаются список,
// звёздочка и слабые валидаторы W/. Сравнение слабое — содержимое по ключу
